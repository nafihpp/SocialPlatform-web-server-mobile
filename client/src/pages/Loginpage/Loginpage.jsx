import PhoneLeft from "../../assets/home-phones.png";
import screen from "../../assets/screenshot3.png";
    ...
    return (
        <div className="flex h-[100vh] items-center justify-center md:flex-wrap md:w-[90%] md:justify-center md:mx-auto rounded-sm">
            ...
            <div className="right-container">
                <div className="login-container w-[350px] max-w-[350px] border-[1px] border-[#dbdbdb] p-3 h-[350px] rounded-[1px]">
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <input
                            ...
                            className="bg-[#fafafa] mb-2 outline-none p-2  border-[1px] border-[#e3e3e3] w-[90%]"
                        />
                        <input
                            type="password"
                            placeholder="password"
                            className="bg-[#fafafa] outline-none p-2 border-[1px] border-[#e3e3e3] w-[90%] "
                        />
                        <div className="w-[90%]">
                            <button className="bg-[#4cb5f9] px-8 py-1 mt-3 text-white w-[100%]">
                                Log in
                            </button>
                        </div>
                ...
                <div className="bottom-box mt-3 border-[1px] w-[350px] max-w-[350px] p-3 text-center">
                    <p>
                        Don't have an Account?{" "}
                        <span className="text-[#4cb5f9]">Sign up</span>
                    </p>
                </div>
                <p className="text-center my-2">Get the App.</p>
                <div className="flex w-[350px] justify-between">
                    <div className="w-48">
                        <img src={playstore} className="w-[100%] block" />
                    </div>
                    <div className="w-40">
                        <img src={appstore} className="w-[100%] block" />
                    </div>
                </div>
            </div>
        </div>
