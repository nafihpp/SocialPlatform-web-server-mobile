...
export const StoriesBar = () => {
    return (
        <div className="h-[119px] flex justify-between items-center bg-[#fafafa] border-t-1 border-b overflow-y-hidden">
            <StoryCard
                image={
            ...
            />
            <StoryCard image={"https://wallpaperaccess.com/full/305936.jpg"} />
            <StoryCard
                image={
